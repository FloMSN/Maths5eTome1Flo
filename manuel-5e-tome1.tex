...
\graphicspath{%
  ...
  {Distributivite/Figures/}%
  {EquationsEtPb/Figures/}%
  {Images/}%
}
...
\include{AddSousFrac/AddSousFrac}

\themaG
\include{CerclesDisques/CerclesEtDisques}

\themaC
\include{Distributivite/Distributivite}
\include{EquationsEtPb/EquationsEtPb}
